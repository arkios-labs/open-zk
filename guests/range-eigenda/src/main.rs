//! EigenDA range proof guest program.
//!
//! Proves a range of L2 blocks using EigenDA as the data availability layer.
...
use alloc::sync::Arc;
use alloc::vec::Vec;
use da_source::EigenDADataSource;
...
impl DaSourceFactory for EigenDaDa {
    type DA = EigenDADataSource<OracleL1ChainProvider<PreimageOracle>, PreimageOracle>;
    ...
    fn create_da_source(
        ...
        EigenDADataSource::new(l1_provider, oracle, rollup_config.batch_inbox_address)
    }
}
...
fn main() {
    ...
    open_zk_guest::pipeline::run(EigenDaDa, store, &io);
}
